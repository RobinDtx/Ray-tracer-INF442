...
class Algorithm {
	public:
		...
		Color phong_reflection_model(const Vector* point, const Vector* normal); //A besoin des 9 k et alpha, de la couleur ambiante, de l'oeil, des lights (couleur et position)
