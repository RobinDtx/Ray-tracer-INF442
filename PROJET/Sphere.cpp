...
Sphere::Sphere(Vector const& center, double radius){
...
Sphere::Sphere(Vector const& center, double radius, Color const& color){
	this->center=  Vector(center.x(), center.y(), center.z());
	this->radius = radius;
	this->color = Color(color.getRed(), color.getGreen(), color.getBlue());
}

Sphere::Sphere(double x, double y, double z, double radius, Color const& color){
	this->center = Vector(x,y,z);
	this->radius = radius;
	this->color = Color(color);
}

Sphere::Sphere(Vector const& center, double radius, unsigned int red, unsigned int green, unsigned int blue){
...
void Sphere::setCenter(Vector const& center){
...
void Sphere::setColor(Color const& color){
